...
def plot_im_megno(im_megnos, parameters, run_name):
    ...
    plt.savefig('1e5_unrestricted_megno_{}.pdf'.format(run_name), bbox_inches='tight')
...
def main():
    ...
    input_im_megnos_filename = '/Users/jsn/landing/data/good_data_mmr/1e5_unrestricted/im_megnos_{}.npy'.format(args.run_name)
